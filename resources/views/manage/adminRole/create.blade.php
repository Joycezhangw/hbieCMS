...
@section('content')
    <form class="layui-form hb-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block hb-len-long">
                <textarea name="role_desc" placeholder="请输入角色描述" class="layui-textarea"></textarea>
            </div>
            <div class="hb-word-aux">
                <p>角色描述最多不超过500个字符</p>
            </div>
...
@section('javascript')
    <script>
        var saveUrl = "{{route('manage.adminRole.store')}}", indexUrl = "{{route('manage.adminRole.index')}}",
            TREE_DATA =<?php echo json_encode($rules);?>;
    </script>
