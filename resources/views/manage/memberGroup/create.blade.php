    ...
    <form class="layui-form hb-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block hb-len-long">
                <input name="group_title" type="text" placeholder="请输入用户组名称" maxlength="16" lay-verify="title"
                       lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" name="is_system" lay-skin="switch" value="1">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">用户组描述：</label>
            <div class="layui-input-block hb-len-long">
                <textarea name="group_remark" placeholder="请输入用户组描述" class="layui-textarea"></textarea>
            </div>
            <div class="hb-word-aux">
...
@section('javascript')
    <script>
        var saveUrl = "{{route('manage.memberGroup.store')}}", indexUrl = "{{route('manage.memberGroup.index')}}";
    </script>
