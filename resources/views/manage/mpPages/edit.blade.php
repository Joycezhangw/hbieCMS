    ...
    <form class="layui-form hb-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block hb-len-long">
                <input name="page_title" type="text" placeholder="请输入页面标题" lay-verify="title" maxlength="6"
                       class="layui-input" value="{{$page['page_title']}}" autocomplete="off">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="checkbox" name="is_show" lay-skin="switch" value="{{$page['is_show']}}"
                       @if(intval($page['is_show'])===1) checked @endif>
            </div>
            <div class="hb-word-aux">
                <p>用于控制前台是否展示</p>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block hb-len-long">
                <input name="page_url" type="text" value="{{$page['page_url']}}" placeholder="请输入前端路由"  lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="hidden" name="page_icon" value="{{$page['page_icon']}}" lay-verify="page_icon">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="page_sort" type="number" value="{{$page['page_sort']}}" placeholder="请输入排序" lay-verify="num"
...
@section('javascript')
    <script>
        var SAVE_URL="{{route('manage.mpPages.update',$page['page_id'])}}",INDEX_URL="{{route('manage.mpPages.index')}}",HB_UPLOAD_URL = "{{route('manage.upload.upload')}}", CSRF_TOKEN = "{{csrf_token()}}"
    </script>
