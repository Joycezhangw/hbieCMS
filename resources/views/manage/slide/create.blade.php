...
@section('content')
    <form class="layui-form hb-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block hb-len-long">
                <input name="slide_page" type="text" placeholder="跳转地址" class="layui-input" autocomplete="off">
            </div>
            <div class="hb-word-aux">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="hidden" name="slide_pic" value="" lay-verify="slide_pic">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="slide_sort" type="number" value="0" placeholder="请输入排序" lay-verify="num"
